export let validateFormDataInputRequired = (formData, inputKey, formErrors, setFormErrors) => {
...
export let validateFormDataInputEmail = (formData, inputKey, formErrors, setFormErrors) => {
...
export let validateFormDataInput = (formData, inputKey, formErrors, setFormErrors, regex, msgError) => {
    // not write Yet
...
export let allowSubmitForm = (formData, formErrors, requiredInputWithNoErrors) => {
    ...
    requiredInputWithNoErrors.forEach(inputKey => {
        ...
        if (formData[inputKey] == null || formErrors[inputKey] != null) {
